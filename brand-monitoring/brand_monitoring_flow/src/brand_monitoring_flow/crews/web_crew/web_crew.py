...
class WebWriterReport(BaseModel):
    ...
    page_link: str = Field(description="The link to the scraped content")
...
class WebReport(BaseModel):   
    content: list[WebWriterReport] = Field(description=("A list of extracted content with title, the page link, "
                                                        "and the bullet points within each unique content page. "
